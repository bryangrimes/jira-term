(function() {
  var PrettyPrinter, colors, moment, options, pad, wrap,
  ...
  PrettyPrinter = (function() {
    ...
    PrettyPrinter.prototype.prettyPrintList = function(issue, detail) {
      var _ref, _ref1;
      ...
      if (detail) {
        if (issue.fields.issuetype != null) {
          ...
          if (_ref = issue.fields.issuetype.name, __indexOf.call(options.bad_types, _ref) >= 0) {
        ...
        if (_ref1 = issue.fields.status.name, __indexOf.call(options.bad_statuses, _ref1) >= 0) {
    ...
    PrettyPrinter.prototype.prettyPrintIssue = function(issue, detail) {
      ...
      if (detail) {
        ...
        if (_ref2 = issue.fields.priority.name, __indexOf.call(options.med_priority, _ref2) >= 0) {
          process.stdout.write(pad(issue.fields.priority.name).medium);
        } else if (_ref3 = issue.fields.priority.name, __indexOf.call(options.high_priority, _ref3) >= 0) {
          process.stdout.write(pad(issue.fields.priority.name).high);
        } else if (_ref4 = issue.fields.priority.name, __indexOf.call(options.critical_priority, _ref4) >= 0) {
